...
public enum Achievement: String, Codable, Hashable, CaseIterable, Identifiable, Sendable {
    ...
    public var name: String {
        ...
        case .exceptionalArtifact1: return "Exceptional relic"
    ...
    public var image: Image? {
        ...
        case .exceptionalArtifact1:
            return Image(systemName: "sparkles.tv")
        case .upgrade5:
    ...
    public var requirement: UnlockRequirement {
        ...
        case .exceptionalArtifact1:
            return .artifactQualityUnlocked(.exceptional)
        case .upgrade5:
    ...
    public var quality: ItemQuality {
        ...
        case .items25, .items100, .artifacts5, .common1, .allEssences, .sacrificed1000, .upgrade5, .research100, .researchLevel10, .doubleItems100, .trades1:
            return .common
        case .doubleItems1000, .trades10, .exceptionalArtifact1:
            return .good
        case .trades100:
            return .rare
