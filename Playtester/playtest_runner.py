...
- Use the get_actions tool to refresh the list of available endpoints (backed by GET /actions).
- Use the get_* tools to inspect current state (items, artifacts, upgrades, achievements).
